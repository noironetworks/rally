...
@scenario.configure(name="ScenarioPlugin.north_south_test4", context={"cleanup@openstack": ["nova", "neutron"],
...
class NorthSouth(create_resources.CreateResources, osutils.OSScenario, gbputils.GBPScenario, neutron_utils.NeutronScenario,
    ...
    def run(self, controller_ip, image, flavor, L3OUT1, L3OUT1_NET, L3OUT1_VRF, L3OUT2,
        ...
        print "Execution of Testcase TEST_NAT_FUNC_4 starts\n"
        ...
        print "Expected FIP Association To Fail since L3P is NOT yet associated to ExtSeg\n"
